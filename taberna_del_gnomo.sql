...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2025 a las 14:05:56
...
(5, 11, 'No llego mi pedido N236', 'Hice una compra de  3 x Blade runner - Pantalla y un Manual de jugador el  23/06/2025  21:31 y no me llego nada ni un gmail de confirmacion', '2025-06-23 21:33:32', NULL);
...
(201, 2, 6500, '2025-06-01 00:00:00'),
(202, 3, 12000, '2025-06-02 00:00:00'),
(203, 3, 6500, '2025-06-03 00:00:00'),
(204, 2, 7600, '2025-06-04 00:00:00'),
(205, 2, 6500, '2025-06-05 00:00:00'),
...
(229, 7, 11450, '2025-06-23 17:21:38'),
(230, 7, 12000, '2025-06-23 20:20:15'),
...
(235, 6, 34000, '2025-06-23 21:13:38'),
(236, 11, 33230, '2025-06-23 21:31:32');
...
(98, 235, 3, 10, 3000, 0, 30000),
(99, 236, 8, 3, 7600, 0, 22800),
(100, 236, 2, 1, 6500, 0, 6500),
(102, 201, 2, 1, 5000, 0, 5000),
(106, 202, 3, 1, 5000, 0, 5000),
(107, 202, 4, 1, 5000, 0, 5000),
(109, 203, 2, 1, 5000, 0, 5000),
(110, 204, 4, 1, 6000, 0, 6000),
(111, 205, 63, 2, 2500, 0, 5000);
...
(2, 'Manual del Jugador', '{\"descripcion\":\"Libro oficial\",\"marca\":\"Wizards of the Coast\",\"edad\":\"+13\",\"jugadores\":\"2 a 6\",\"formato\":\"Hardcover \\/ Tapa dura\"}', 1, 0, 6500, 31, NULL, '1749076366_01a686f3d41ce76a99a5.jpg'),
(3, 'Set de Dados Metálicos', 'Dados premium', 2, 0, 3000, 34, NULL, '1749076394_fa42aadc62e204fb78ac.jpg'),
(4, 'Manual de Monstruos', '{\"descripcion\":\"Libro oficial\",\"marca\":\"Wizards of the Coast\",\"edad\":\"+13\",\"jugadores\":\"2 a 6\",\"formato\":\"Hardcover \\/ Tapa dura\"}', 1, 0, 5000, 2, NULL, '1749076382_b9601dc266e34dfc64f2.jpg'),
...
(8, 'Blade runner - Pantalla', '{\"descripcion\":\"Pantalla para el juego de rol de Blade runner.\",\"marca\":\"\",\"edad\":\" +14\",\"jugadores\":\"\",\"formato\":\"\"}', 5, 0, 7600, 26, NULL, '1750289619_3bb609a5fce387fe4724.webp'),
...
(6, 'admin', 'admin', 'admin', 'admin', 'admin@gmail.com', '$2y$10$JkVixP2zbtGxdts7GIDJNegYQOJGPGEpKuGOb9OW1YX7z.MhXzioi', NULL),
...
(9, 'cliente1', 'Cliente', 'Cliente', 'user', 'cliente@cliente.com', '$2y$10$/0ZUek7yu1ZJi4V8Wgx.TeDXhLQusNgOBFVki4VT5pSfXboFB6tcG', NULL),
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;

--
-- AUTO_INCREMENT de la tabla `invoice_item`
--
ALTER TABLE `invoice_item`
  MODIFY `invoice_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
